<template>
  <div>
    <div class="container py-5">
      <h2>Village house in Bago on Lantau Island</h2>
      <div class="rating my-2 d-flex align-items-center fw-light">
        ...
        <span class="ms-2">Bago, Bago</span>
      </div>

      <div class="gallery">
        <div class="gallery-img gallery-img-1">
          <img src="../assets/img/room-1.webp" alt="" />
        </div>
      ...
      <div class="row mt-5">
        <div class="col-md-7">
          <div class="room-info d-flex justify-content-between align-items-center border-bottom pb-4">
            <div>
              <h4>Entire residential home hosted by John</h4>
              <div class="fw-light">
                <span class="me-2">6 guests</span>
                <span class="me-2">.</span>
                <span class="me-2">4 bedrooms</span>
                <span class="me-2">.</span>
                <span class="me-2">4 beds</span>
                <span class="me-2">.</span>
                <span class="me-2">2 baths</span>
              </div>
            </div>
            <div>
          ...
          <div class="room-description py-5 border-bottom">
            ...
            <p>
              Enhanced Cleaning. The room is bright and airy & can accommodate a max of 2 guests as it has a double &
              single bed. NO KITCHEN FACILITIES ARE AVAILABLE FOR GUESTS, but Kettle facilities are in the room. The
              bathroom is shared, shampoo/shower gel is provided. Morden Tube (35 mins to central London) and bus
              station is just a 7 min walk with many cafes there for breakfast. The tram stop is just 12 mins walk and
              Wimbledon is a very pleasant 20 min walk to the district line and mainline station.
            </p>
          </div>
