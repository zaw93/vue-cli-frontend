    ...
    <div class="container py-5">
      ...
      <div class="gallery">
        ...
        <!-- <div class="gallery-img gallery-img-2">
          <img src="../assets/img/room-2.webp" alt="" />
        </div>
        <div class="gallery-img gallery-img-3">
          <img src="../assets/img/room-3.webp" alt="" />
        </div>
        <div class="gallery-img gallery-img-4">
          <img src="../assets/img/room-4.webp" alt="" />
        </div>
        <div class="gallery-img gallery-img-5">
          <img src="../assets/img/room-5.webp" alt="" />
        </div> -->
      </div>
      ...
      <div class="row mt-5">
        <div class="col-md-7">
          ...
          <div class="room-amenities py-5">
            ...
            <div class="d-flex justify-content-between">
              <div class="f-col">
                <div v-if="place.amenities.includes('Breakfast')" class="d-flex align-items-center mb-3">
                ...
                <div v-if="place.amenities.includes('Kitchen')" class="d-flex align-items-center mb-3">
                  <svg
                    viewBox="0 0 32 32"
                    class="me-4"
                ...
                <div v-if="place.amenities.includes('Microwave')" class="d-flex align-items-center mb-3">
                  <svg
                    viewBox="0 0 32 32"
                    class="me-4"
                    style="display: block; height: 24px; width: 24px; fill: currentcolor;"
                ...
                <div v-if="place.amenities.includes('Bathtub')" class="d-flex align-items-center mb-3">
                  <svg
                    viewBox="0 0 32 32"
                    class="me-4"
                    style="display: block; height: 24px; width: 24px; fill: currentcolor;"
                ...
                <div v-if="place.amenities.includes('Hair dryer')" class="d-flex align-items-center mb-3">
                  <svg
                    viewBox="0 0 32 32"
                    class="me-4"
                    style="display: block; height: 24px; width: 24px; fill: currentcolor;"
                ...
                <div v-if="place.amenities.includes('Iron')" class="d-flex align-items-center mb-3">
                  <svg
                    viewBox="0 0 32 32"
                    class="me-4"
                    style="display: block; height: 24px; width: 24px; fill: currentcolor;"
              ...
              <div class="s-col">
                <div v-if="place.amenities.includes('Refrigerator')" class="d-flex align-items-center mb-3">
                  <svg viewBox="0 0 32 32" class="me-4" style="height: 24px; width: 24px; fill: currentcolor;">
                    <path
                ...
                <div v-if="place.amenities.includes('Washer')" class="d-flex align-items-center mb-3">
                  <svg viewBox="0 0 32 32" class="me-4" style="height: 24px; width: 24px; fill: currentcolor;">
                    <path
                ...
                <div v-if="place.amenities.includes('Air conditioning')" class="d-flex align-items-center mb-3">
                  <svg viewBox="0 0 32 32" class="me-4" style="height: 24px; width: 24px; fill: currentcolor;">
                    <path
                ...
                <div v-if="place.amenities.includes('Wifi')" class="d-flex align-items-center mb-3">
                  <svg viewBox="0 0 32 32" class="me-4" style="height: 24px; width: 24px; fill: currentcolor;">
                    <path
                ...
                <div v-if="place.amenities.includes('TV')" class="d-flex align-items-center mb-3">
                  <svg viewBox="0 0 32 32" class="me-4" style="height: 24px; width: 24px; fill: currentcolor;">
                    <path
        ...
        <BookCard :guest-count="place.guest_count" />
      </div>
...
export default {
  ...
  computed: {
    place() {
      return this.$store.getters['places/place']
    },
    roomTitleByHost() {
